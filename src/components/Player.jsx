  ...
  return (
    <div className='px-2 sm:px-5 md:px-10 py-6 bg-gray-500/50 rounded-lg border border-lime-50/30 flex flex-col items-center'>
      ...
      <div className='flex items-center gap-5 mt-6'>
        ...
        <button onClick={() => setPlaying(!playing)} className='rounded-full bg-lime-400 p-2 border border-lime-50/30 cursor-pointer'>{playing ? (<img src={pause} alt="" className=' size-5'/>) : (<img src={play} alt="" className=' size-5'/>)}</button>
